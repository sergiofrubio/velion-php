...
function addReglement( $mode )
{
	...
	$this->SetFont( "Arial", "B", 10);
	$this->Cell(10,4, "METODO DE PAGO", 0, 0, "C");
...
function addCadreTVAs()
{
	...
	$this->Line( $r1+5,  $y1+4, $r1+5, $y2); // avant BASE
	$this->Line( $r1+27, $y1, $r1+27, $y2);  // avant DESC.
...
function addCadreTotal($monto)
{
	...
	$this->SetXY( $r1, $y1+10 );
	$this->Cell(20,4, "DEPOSITO", 0, 0, "C");
	$this->SetXY( $r1, $y1+15 );
	$this->Cell(20,4, "NETO PAGAR", 0, 0, "C");
}
